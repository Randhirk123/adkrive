							...
							<div class="sidebar-submenu sidebar-submenu__open ">
								<ul>
									...
									<li class="sidebar-menu-item active"><a
										href="/withdraw/method" class="nav-link"> <i
											class="menu-icon las la-dot-circle"></i> <span
											class="menu-title">Withdraw Methods</span>
									</a></li>
			...
			<div class="bodywrapper__inner">
				<div class="row align-items-center mb-30 justify-content-between">
					...
					<div
						...
						<a class="btn btn-sm btn--primary box--shadow1 text--small"
							href="/withdraw/method/create"><i class="fa fa-fw fa-plus"></i>Add
							New</a>
					</div>
				</div>
												...
												<c:otherwise>
													...
													<c:forEach items="${listWithdrawMethod}" var="element"
														...
														<tr>
															...
															<td data-label="Method">
																<div class="user">
																	<div class="thumb">
																		...
																		<c:forEach begin="${loop.index}" items="${images}"
																			var="img" end="${loop.index}">
															...
															<td data-label="Currency" class="font-weight-bold">${element.currency}</td>
															<td data-label="Charge" class="font-weight-bold">${element.fixed_charge}
																INR + ${element.percent_charge} %</td>
															<td data-label="Withdraw Limit" class="font-weight-bold">${element.min_limit}
																- ${element.max_limit} INR</td>
															...
															<td data-label="Status"><c:if
																	...
																	<span
																		class="text--small badge font-weight-normal badge--warning">Deactive</span>
																</c:if></td>
															<td data-label="Action"><a
																href="/withdraw/method/edit/${element.id}"
																class="icon-btn ml-1" data-toggle="tooltip"
																data-original-title="Edit"><i class="las la-pen"></i></a>
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Withdrawal Method Activation
									Confirmation</h5>
							...
							<form:form action="/withdraw/method/activate" method="POST" modelAttribute="withMethod">
								<input type="hidden" name="_token"
									value="kCKIuQUDWqQ2FnqRj7aAqnGJts3gpBLtGT0JeRbn"> <input
									type="hidden" name="id">
								<div class="modal-body">
									<p>
										Are you sure to activate <span
											class="font-weight-bold method-name"></span> method?
									</p>
								</div>
				...
				<div id="deactivateModal" class="modal fade" tabindex="-1"
					...
					<div class="modal-dialog" role="document">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title">Withdrawal Method Disable
									Confirmation</h5>
								<button type="button" class="close" data-dismiss="modal"
									aria-label="Close">
									<span aria-hidden="true">&times;</span>
							...
							<form:form action="/withdraw/method/deactivate" method="POST" modelAttribute="withMethod">
								<input type="hidden" name="_token"
									value="kCKIuQUDWqQ2FnqRj7aAqnGJts3gpBLtGT0JeRbn"> <input
									type="hidden" name="id">
								<div class="modal-body">
