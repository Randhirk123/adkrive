...
<head>
   ...
   <title>Publisher Withdrawals : ${publish.name}</title>
    <!-- site favicon -->
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Publisher Withdrawals : ${publish.name}</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
        
<form
    action="/withdraw/log/search"
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <c:choose>
                        				...
                        				<c:when test="${empty pubWithdrawList}">
                        					   <td class="text-muted text-center" colspan="100%">No withdrawal history</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${pubWithdrawList}" var="element">
