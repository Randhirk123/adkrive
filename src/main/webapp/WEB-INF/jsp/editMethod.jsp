...
<head>
    ...
    <title>AdKrive - Update Withdraw Method</title>
    <!-- site favicon -->
     <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Update Withdraw Method</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
            <a href="/withdraw/method" class="btn btn-sm btn--primary box--shadow1 text--small">
        <i class="la la-fw la-backward"></i> Go Back    </a>
    </div>
</div>
                    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <form:form action="/withdraw/method/edit/${id}" method="POST" modelAttribute="withMethod"
                      enctype="multipart/form-data">
                    <input type="hidden" name="_token" value="v8aASm6pp2e5SEVvjq75d7BOlGusz484XOo6pXpM">                    <div class="card-body">
                        <h6 class="card-title mb-20">Method Update Form</h6>
                        <div class="payment-method-item">
                            <div class="payment-method-header d-flex flex-wrap">
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview" style="background-image: url(data:image/png;base64,${image1})"></div>
                                    </div>
                                ...
                                <div class="content">
                                    <div class="d-flex justify-content-between">
                                        <input type="text" class="form-control" placeholder="Method Name" name="name" value="${withMethod.name}"/>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" name="currency" class="form-control border-radius-5" value="${withMethod.currency}"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group has_append">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">1 INR
                                                            =
                                                        </div>
                                                    </div>
                                                    <input type="text" class="form-control" placeholder="0" name="rate" value="${withMethod.rate}"/>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="delay" class="form-control border-radius-5" value="${withMethod.delay}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                        ...
                                        <div class="card border--primary mb-2">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group has_append mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="min_limit" placeholder="0" value="${withMethod.min_limit}"/>
                                                    <div class="input-group-append">
                                                ...
                                                <div class="input-group has_append">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="max_limit" value="${withMethod.max_limit}"/>
                                                    <div class="input-group-append">
                                                        <div class="input-group-text"> INR </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card border--primary">
                                            ...
                                            <div class="card-body">
                                                <div class="input-group has_append mb-3">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="fixed_charge" value="${withMethod.fixed_charge}"/>
                                                    <div class="input-group-append">
                                                        <div class="input-group-text"> INR </div>
                                                    </div>
                                                </div>
                                                <div class="input-group has_append">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="0" name="percent_charge" value="${withMethod.percent_charge}">
                                                    <div class="input-group-append">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="card border--dark my-2">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <textarea rows="5" class="form-control border-radius-5 nicEdit" name="description">&lt;font size=&quot;2&quot;&gt; ${withMethod.description} &lt;/font&gt;</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
