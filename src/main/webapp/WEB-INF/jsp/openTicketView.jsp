	...
	<div class="page-wrapper default-version">
		...
		<div class="body-wrapper">
			<div class="bodywrapper__inner">
				<div class="row align-items-center mb-30 justify-content-between">
					...
					<div
						...
						<a href="/tickets"
							...
							class="la la-fw la-backward"></i> Go Back </a>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<div class="card">
							<div class="card-body ">
								<h6 class="card-title  mb-4">
									<div class="row">
										<div class="col-sm-8 col-md-6">
											<span
												class="text--small badge font-weight-normal bg--success py-1 px-2">Open</span>
											[${openTktView.subject}]
										</div>
								...
								<form:form action="/ticket/reply/${id}" enctype="multipart/form-data"
									method="post" class="form-horizontal">
									<input type="hidden" name="_token"
										value="82Sza2rjMd8IHohV7BkO7s4rANcxviYy3XPo4plI">

									<div class="row ">
										<div class="col-md-12">
											<div class="form-group">
												<textarea class="form-control" name="message" rows="3"
													id="inputMessage" placeholder="Your Message ..."></textarea>
											</div>
										</div>
										<div class="col-md-6">
											<div class="row form-group">
												...
												<div class="col-9 ">
													<div class="file-upload-wrapper"
														...
														<input type="file" name="attachments[]"
															id="inputAttachments" class="file-upload-field" />
													</div>
												...
												<div
													class="col-md-12 ticket-attachments-message text-muted mt-3">
													Allowed File Extensions: .jpg, .jpeg, .png, .pdf,</div>
											</div>
										</div>
										<div class="col-md-3 offset-md-3">
											<button class="btn btn--primary btn-block mt-4" type="submit"
												name="replayTicket" value="${admin.id}">
								...
								<div class="row border border-primary border-radius-3 my-3 mx-2">
									...
									<div class="col-md-3 border-right text-right">
										...
										<a href="/publisher/details/${openTktView.publisher_id}">${publish.name}</a>
										<button data-id="6" type="button" data-toggle="modal"
											data-target="#DelMessage"
											class="btn btn-danger btn-sm my-3 delete-message">
											<i class="la la-trash"></i> Delete
										</button>
									</div>

									<div class="col-md-9">
										<p class="text-muted font-weight-bold my-3">Posted on
											Saturday, 06th November 2021 @ 16:06</p>
										<p>Fun to check</p>
									</div>
							...
							<div class="modal-footer">
								<form method="post" action="/ticket/reply/${id}">
									...
									<button type="submit" class="btn btn--success"
										name="replayTicket" value="2">Close Ticket</button>
								</form>
							</div>
				...
				<div class="modal fade" id="DelMessage" tabindex="-1" role="dialog"
					aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
							...
							<div class="modal-footer">
								<form method="post" action="/ticket/delete">
									<input type="hidden" name="_token"
										value="82Sza2rjMd8IHohV7BkO7s4rANcxviYy3XPo4plI"> <input
										type="hidden" name="message_id" class="message_id">
									<button type="button" class="btn btn--secondary"
										data-dismiss="modal">No</button>
