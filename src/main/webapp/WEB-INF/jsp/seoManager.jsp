...
<title>AdKrive - SEO Configuration</title>
<base
						...
						<li class="sidebar-menu-item sidebar-dropdown"><a
							...
							<div class="sidebar-submenu sidebar-submenu__open ">
								<ul>
									...
									<li class="sidebar-menu-item active"><a href="/seo"
			...
			<div class="bodywrapper__inner">
				...
				<div class="row">
					<div class="col-lg-12 col-md-12 mb-30">
						<div class="card">
							<div class="card-body">
								<form:form action="/frontend/frontend-content/seo" method="POST" modelAttribute="seoMgr"
									enctype="multipart/form-data">
									<input type="hidden" name="_token"
										value="gd0di8fpvrFRZPthkm2DqjaiEp1HyNRFCUe5HFCA"> <input
										type="hidden" name="type" value="data"> <input
										type="hidden" name="seo_image" value="1">
									<div class="row">
										<div class="col-xl-4">
													...
													<div class="thumb">
														<div class="avatar-preview">
															<div class="profilePicPreview"
																style="background-image: url(https://adjuction.in/assets/images/seo/606aa8c22a4221617602754.png)">
														...
														<div class="avatar-edit">
															<input type="file" class="profilePicUpload"
																...
																for="profilePicUpload1" class="bg--success">Upload
																Image</label> <small class="mt-2 text-facebook">Supported
																files: <b>jpeg, jpg</b>. Image will be resized into
																600x315px.
															</small>
														</div>
													</div>
										...
										<div class="col-xl-8 mt-xl-0 mt-4">
											<div class="form-group ">
												<label class="form-control-label font-weight-bold">Meta
													Keywords</label> <small class="ml-2 mt-2 text-facebook">Separate
													multiple keywords by <code>,</code>(comma) or <code>enter</code>
													key
												</small> <select name="keywords[]"
													class="form-control select2-auto-tokenize"
													multiple="multiple" required>
													<option value="advertises" selected>advertises</option>
													<option value="add" selected>add</option>
													<option value="Advertising" selected>Advertising</option>
													<option value="ad" selected>ad</option>
													<option value="ad marketplace" selected>ad
														marketplace</option>
													<option value="ad network" selected>ad network</option>
													<option value="ad network script" selected>ad
														network script</option>
													<option value="ads" selected>ads</option>
													<option value="ads network" selected>ads network</option>
													<option value="ads script" selected>ads script</option>
													<option value="advertisement" selected>advertisement</option>
													<option value="advertiser" selected>advertiser</option>
													<option value="digital ads" selected>digital ads</option>
													<option value="online ads" selected>online ads</option>
													<option value="php ad network" selected>php ad
														network</option>
													<option value="publisher" selected>publisher</option>
													<option value="targeted ads" selected>targeted ads</option>
											...
											<div class="form-group">
												...
												<textarea name="description" rows="3" class="form-control"
													placeholder="SEO meta description" required>adsRook has perfectly suited your Business or service provider company. This is a marketplace where advertisers and publishers (webmasters) come together to sell and purchase ad space. Its created to help you launch a professional website with the latest technologies. adsRook allows you to create multiple forms with custom permissions for every single part of your website and control them in an easy manner. Adweeby supports unlimited advertisers, publishers, and advertisements.</textarea>
											</div>
											<div class="form-group">
												<label class="form-control-label  font-weight-bold">Social
													Title</label> <input type="text" class="form-control"
													placeholder="Social Share Title" name="social_title"
													value="AdsRook" required />
											</div>
											<div class="form-group">
												<label class="form-control-label  font-weight-bold">Social
													Description</label>
												<textarea name="social_description" rows="3"
													class="form-control"
													placeholder="Social Share  meta description" required>adsRook has perfectly suited your Business or service provider company. This is a marketplace where advertisers and publishers (webmasters) come together to sell and purchase ad space. Its created to help you launch a professional website with the latest technologies. adsRook allows you to create multiple forms with custom permissions for every single part of your website and control them in an easy manner. Adweeby supports unlimited advertisers, publishers, and advertisements.</textarea>
											</div>
											<div class="form-group">
												<button type="submit"
