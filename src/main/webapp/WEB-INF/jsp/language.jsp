...
<title>AdKrive - Language Manager</title>
<base
						...
						<li class="sidebar-menu-item sidebar-dropdown"><a
							...
							<div class="sidebar-submenu sidebar-submenu__open ">
								<ul>
									...
									<li class="sidebar-menu-item active "><a href="/language"
			...
			<div class="bodywrapper__inner">
				<div class="row align-items-center mb-30 justify-content-between">
					...
					<div
						...
						<a
							class="btn btn-sm btn--primary box--shadow1 text-white text--small"
							data-toggle="modal" data-target="#myModal"><i
							class="fa fa-fw fa-plus"></i>Add New Language</a>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12">
						<div class="card b-radius--10 ">
							<div class="card-body p-0">
								<div class="table-responsive--sm table-responsive">
									<table
										class="table table--light tabstyle--two custom-data-table">
										<thead>
											<tr>
										...
										<tbody>
											...
											<c:choose>
												...
												<c:otherwise>
													<c:forEach items="${langList}" var="element">

														<tr>
															<td data-label="Name">${element.name}</td>
															<td data-label="Code"><strong>${element.code}</strong></td>
															<td data-label="status"> <c:if test="${element.is_default eq 1}"><span class="text--small badge font-weight-normal badge--success">default</span></c:if>  
                                           <c:if test="${element.is_default eq 0}"><span class="text--small badge font-weight-normal badge--warning">Selectable</span></c:if> 
															</td>
															<td data-label="Action"><a
																href="/language/edit/${element.id}"
																class="icon-btn btn--success" data-toggle="tooltip"
																data-original-title="Translate"> <i
																	class="la la-code"></i>
															</a> <a href="javascript:void(0)"
																class="icon-btn ml-1 editBtn" data-original-title="Edit"
																data-toggle="tooltip"
																data-url="/language/update/${element.id}"
																data-lang="{&quot;name&quot;:&quot;${element.name}&quot;,&quot;text_align&quot;:${element.text_align},&quot;is_default&quot;:${element.is_default}}"
																data-icon="https://adjuction.in/placeholder-image/64x64">
						...
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="myModalLabel">
									<i class="fa fa-share-square"></i> Add New Language
								</h4>
							...
							<form:form class="form-horizontal" method="post" modelAttribute="lang"
								action="/language"
								...
								<div class="modal-body">
									<div class="form-row form-group">
										<label class="font-weight-bold ">Language Name <span
											class="text-danger">*</span></label>
										<div class="col-sm-12">
											<input type="text" class="form-control has-error bold "
												id="code" name="name"
												placeholder="e.g. Japaneese, Portuguese" required>
										</div>
									</div>

									<div class="form-row form-group">
										<label class="font-weight-bold">Language Code <span
											class="text-danger">*</span></label>
										<div class="col-sm-12">
											<input type="text" class="form-control has-error bold "
												id="link" name="code" placeholder="e.g. jp, pt-br" required>
										</div>
									</div>

									<div class="form-row form-group">
										<div class="col-md-6  d-none">
											<label class="font-weight-bold">Text Direction <span
												class="text-danger">*</span></label> <select name="text_align"
												class="form-control">
										...
										<div class="col-md-12">
											<label for="inputName" class="">Default Language <span
												class="text-danger">*</span></label>
												 <input type="checkbox"
												data-width="100%" data-height="40px" data-onstyle="-success"
												data-offstyle="-danger" data-toggle="toggle" data-on="SET"
												data-off="UNSET" name="is_default1"
												
												<c:if test="${lang.is_default eq 1}">checked="checked"</c:if>/>
											<input type="hidden" value="0" name="_is_default1" id="chk_0" />
				...
				<div class="modal fade" id="editModal" tabindex="-1" role="dialog"
					...
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<h4 class="modal-title" id="myModalLabel">
									<i class="fa fa-fw fa-share-square"></i>Edit Language
								</h4>
								<button type="button" class="close" data-dismiss="modal"
									aria-label="Close">
									<span aria-hidden="true">×</span>
							...
							<form:form method="post" enctype="multipart/form-data" modelAttribute="lang">
								<input type="hidden" name="_token"
									value="h33on3gY7fo1My5PeWehAJ87x2BKRrOwmrBXQP2u">
								<div class="modal-body">
									<div class="form-row">
										<label for="inputName" class="font-weight-bold">Language
											Name <span class="text-danger">*</span>
										</label>
										<div class="col-sm-12">
											<input type="text" class="form-control has-error bold"
												id="code" name="name" required>
										</div>
									</div>

									<div class="form-group mt-2">
										<label for="inputName" class="font-weight-bold">Default
											Language <span class="text-danger">*</span>
										</label> <input type="checkbox" data-width="100%" data-height="40px"
											data-onstyle="-success" data-offstyle="-danger"
											data-toggle="toggle" data-on="SET" data-off="UNSET"
											name="is_default1" 
						...
						<div class="modal-content">
							...
							<form method="post" action="">
								<input type="hidden" name="_token"
									...
									type="hidden" name="delete_id" id="delete_id" class="delete_id"
									value="0">
								<div class="modal-body">
		...
		(function($) {
			...
			$('.editBtn').on(
					...
					function() {
						...
						modal.find('select[name=text_align]').val(
								lang.text_align);
						if (lang.is_default == 1) {
							modal.find('input[name=is_default]')
									.bootstrapToggle('on');
						} else {
							modal.find('input[name=is_default]')
									.bootstrapToggle('off');
