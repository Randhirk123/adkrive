...
<body>
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">SMS API</h6>
    ...
    <div class="row mb-none-30">
        ...
        <div class="col-lg-12 col-md-12 mb-30">
            <div class="card">
                <div class="card-body">
                    <form:form action="/sms-template/global" method="POST" modelAttribute="global">
                        <input type="hidden" name="_token" value="UYQ8fNUujvswib1IQbPkAkcOQMkXqLUMEs3FlSP0">                        <div class="card-header">
                            <h4 class="float-left">SMS API</h4>
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" class="form-control" placeholder="SMS API Configuration" name="sms_api" value="${global.sms_api}" required/>
                                </div>
                            </div>
                        </div>
    ...
    <div id="testSMSModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form:form action="/email-template/send-test-sms" method="POST">
                    <input type="hidden" name="_token" value="UYQ8fNUujvswib1IQbPkAkcOQMkXqLUMEs3FlSP0">                    <input type="hidden" name="id">
