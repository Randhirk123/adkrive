    ...
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="images/1.jpg">
            <div class="form-wrapper">
                <h4 class="logo-text mb-15"><strong>Reset Your Password</strong></h4>
                <form action="/reset_password" method="POST" class="cmn-form mt-30">
                    <input type="hidden" name="token" value="${token}">
					<div class="form-group">
					 <label for=""></label>
                        <input type="password" name="password" class="form-control b-radius--capsule" id="username" value="" placeholder="Enter your new password">
                        <i class="las la-lock input-icon" style="margin-top:-6px;"></i>
                    </div>
					<div class="form-group">
						<label for=""></label>
                        <input type="password" name="password" class="form-control b-radius--capsule" id="username" value="" placeholder="Confirm your new password">
                        <i class="las la-lock input-icon" style="margin-top:-6px;"></i>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="submit-btn mt-25 b-radius--capsule">Change Password<i class="las la-sign-in-alt"></i></button>
                    </div>
                </form>
            </div>
        </div><!-- login-area end -->
