...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
   <title>AdKrive - Global Email Template</title>
<base
...
<body>
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Global Email Template</h6>
    </div>
    ...
    <div class="row">
                ...
                <div class="card-body p-0">
                    <div class="table-responsive table-responsive--sm">
                        <table class=" table align-items-center table--light">
                            ...
                            <tbody class="list">
                            <tr>
                                <td data-label="Short Code">{{name}}</td>
                                <td data-label="Description">User Name</td>
                            </tr>
                            <tr>
                                <td data-label="Short Code">{{message}}</td>
                                <td data-label="Description">Message</td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
        ...
        <div class="col-md-12">
            <div class="card mt-5">
                <div class="card-body">
                    <form:form action="/email-template/global" method="POST" modelAttribute="global">
                        <input type="hidden" name="_token" value="METafdt3MKd1Zxoiw5yfGdTNQkl86VQHI4t5xo15">                        <div class="form-row">

                            <div class="form-group col-md-12">
                                <label class="font-weight-bold">Email Sent From <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-lg" placeholder="Email address" name="email_from" value="${global.email_from}" required/>
                            </div>
                            <div class="form-group col-md-12">
                                <label class="font-weight-bold">Email Body <span class="text-danger">*</span></label>
                                <textarea name="email_template" rows="10" class="form-control form-control-lg nicEdit" placeholder="Your email template">${global.email_template}</textarea>
                            </div>
                        </div>
