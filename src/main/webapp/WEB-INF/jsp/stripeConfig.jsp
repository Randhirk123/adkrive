...
<body>
	...
	<!-- NEWLY ADDED FEEDS OPTION START-->
		 ...
		 <div class="body-wrapper">
            <div class="bodywrapper__inner">
    			...
    			<div class="col-lg-6 col-sm-6">
        			<h6 class="page-title">Stripe Configuration</h6>				
    			</div>
        ...
        <form:form action="/gateway/automatic/edit/${pmnt.name}" method="POST" modelAttribute="pmnt"
            enctype="multipart/form-data">
            <div class="row justify-content-center">
                <div class="col-xl-12 col-lg-12">
                    <div class="card mt-25">
                        <div class="card-body">
                            <h5 class="card-title mb-15 border-bottom pb-2">Configure Stripe</h5>
                                                                
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="form-control-label font-weight-bold">STRIPE_PUBLIC_KEY</label>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group ">
                                            <label class="form-control-label font-weight-bold">STRIPE_SECRET_KEY<span class="text-danger">*</span></label>
