												...
												<c:otherwise>
													<c:forEach items="${pricePlanList}" var="element">
														...
														<tr>
															...
															<td data-label="Type">
																	<c:if test="${element.type eq 'Impression'}"><span class="text--small badge font-weight-normal badge--warning bg--">Impression</span></c:if>
																	<c:if test="${element.type eq 'Click'}">
																		<span class="text--small badge font-weight-normal badge--dark bg--">Click</span>
																	</c:if>
															</td>
