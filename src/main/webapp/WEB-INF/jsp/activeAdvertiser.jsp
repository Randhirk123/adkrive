...
<title>AdKrive - All Active Advertisers</title>
<!-- site favicon -->
<base
			...
			<div class="bodywrapper__inner">
				<div class="row align-items-center mb-30 justify-content-between">
					...
					<div
						...
						id="hide">
						<form action="/advertiser/active/search" method="GET"
											...
											<!-- for all Advertiser search only -->
											 ...
											 <c:if test="${search eq 'activeSearch'}">
												...
												<c:choose>
													...
													<c:otherwise>
														<c:forEach items="${activeSearchList}" var="element">
															<tr>
