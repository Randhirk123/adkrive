...
<body>
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Ad Feed</h6>
    </div>
    </div>
			...
			<div class="row " style="margin-left: 200px;">
				...
				<form:form method="post" action="/saveFeed" modelAttribute="feeds">
				
					<div class="form-group">
						<label for="feedNetwork">Select Network</label> 
						<select name="feedNetwork" required="required">
							<c:forEach items="${networkList}" var="element">
								<option  value="${element.networkId}">${element.newtworkName}</option>
							</c:forEach>
						</select>
					</div>
					...
					<div class="form-group">
						<label for="FeedName">Feed Name</label> <input
							type="text" class="form-control" name="feedName"
							 placeholder="Enter Feed Name" required="required"> 
					</div>
					<div class="form-group">
						<label for="maxdailyQuery">Max Daily Queries</label> <input
							type="number" class="form-control" name="dailyMaxQuery"
							placeholder="Max Daily Queries" required="required">
					</div>
					
					<div class="form-group">
						<label for="revenue share">Revenue Share</label> <input
							type="number" class="form-control" name="revenueShare"
							placeholder="Revenue Share" required="required">
					</div>
					
					
					<div class="form-group">
						<label for="platform">Platform</label> <input
							type="text" class="form-control" name="platform"
