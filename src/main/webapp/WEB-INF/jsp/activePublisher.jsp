...
<title>AdKrive - All Active publishers</title>
<!-- site favicon -->
<base
			...
			<div class="bodywrapper__inner">
				<div class="row align-items-center mb-30 justify-content-between">
					<div class="col-lg-6 col-sm-6">
						<h6 class="page-title" id="change">All Active  publishers</h6>
					</div>
					<div
						class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part"
						id="hide">
						<form action="/publisher/active/search" method="GET"
								...
								<div class="table-responsive--md  table-responsive">
									<table class="table table--light style--two">
										...
										<tbody>
											...
											<!-- for all active publisher  search only -->

											
												<c:if test="${search eq 'activeSearch'}">
												 <c:choose>
