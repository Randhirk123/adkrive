...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
   <title>AdKrive - SMS Templates</title>
<base
...
<body>
 ...
 <span class="navbar-user">
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">SMS Templates</h6>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two custom-data-table">
                            ...
                            <tbody>
                            <c:choose>
                            			<c:when test="${empty smsMgrList}">
													<td class="text-muted text-center" colspan="100%">No
														SMS Template found</td>
												</c:when>
                            			<c:otherwise>
                            				<c:forEach items="${smsMgrList}" var="element">
                            				
                            				  <tr>
                                    <td data-label="Name">${element.name}</td>

                                    <td data-label="Status">
                                    <c:if test="${element.sms_status eq 1}"><span class="text--small badge font-weight-normal badge--success">Active</span></c:if>  
                                           <c:if test="${element.sms_status eq 0}"><span class="text--small badge font-weight-normal badge--warning">Disable</span></c:if>  </td>
                                                                           

                                    <td data-label="Action">
                                        <a href="/sms-template/edit/${element.id}"
