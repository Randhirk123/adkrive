...
<body>
 ...
 <span class="navbar-user">
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">${sms.name}</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
            <a href="/sms-template/index" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="fa fa-fw fa-backward"></i> Go Back </a>
    </div>
</div>
                    <div class="row">
        <div class="col-lg-12">
        ...
        <div class="col-lg-12">
            ...
            <div class="card mt-5">
                <div class="card-header bg--dark">
                    <h5 class="card-title text-white">${sms.name}</h5>
                </div>
                <form:form action="/sms-template/update/${id}" method="POST" modelAttribute="sms">
                    <input type="hidden" name="_token" value="UYQ8fNUujvswib1IQbPkAkcOQMkXqLUMEs3FlSP0">                    <div class="card-body">
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">Status <span class="text-danger">*</span></label>
                                <input type="checkbox" data-height="46px" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="Send SMS" data-off="Don't Send" name="sms_status1" 
                                <c:if test="${sms.sms_status eq 1}">checked="checked"</c:if> />
											<input type="hidden" value="0" name="_sms_status1" id="chk_1" />
                            </div>

                            <div class="form-group col-md-12">
                                <label class="font-weight-bold">Message <span class="text-danger">*</span></label>
                                <textarea name="sms_body" rows="10" class="form-control" placeholder="Your message using shortcodes">${sms.sms_body}</textarea>
                            </div>
                        </div>
                    </div>
