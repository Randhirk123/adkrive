...
<head>
    ...
    <title>AdKrive - sendMailToPublisher</title>
    <!-- site favicon -->
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Send Email To: ${advertise.name}</h6>
    ...
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
        ...
        <div class="col-xl-12">
            <div class="card">
                <form:form action="/user/send-email/${advertise.id}/0" method="POST" modelAttribute="advertise">
