...
<title>AdKrive - Edit Feeds</title>
<base
...
<body>
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Edit Feed</h6>
    </div>
    </div>
			...
			<div class="row " style="margin-left: 200px;">
				...
				<form:form method="post" action="/feedEdit" modelAttribute="feeds">
				
				
					<div class="form-group">
						<label for="FeedId">Feed Id</label> <input
							type="number" class="form-control" name="feedId" readonly="readonly" value="${feeds.feedId}"> 
					</div>
					
					<div class="form-group">
						<label for="NativeId">Native Id</label> <input
							type="text" class="form-control" name="native_id" readonly="readonly" value="${feeds.native_id}"> 
					</div>
					
					<div class="form-group">
						<label for="feedNetwork">Select Network</label> 
						<select  name="network">
							<c:forEach items="${networkList}" var="element">
								 <option value="${element}"${feeds.feedNetwork.newtworkName ==element.newtworkName ? 'selected' : ''}>${element.newtworkName}</option>
							</c:forEach>
						</select>
					</div>
				
					<div class="form-group">
						<label for="FeedName">Feed Name</label> <input
							type="text" class="form-control" name="feedName" value="${feeds.feedName}" required="required"> 
					</div>
					<div class="form-group">
						<label for="maxdailyQuery">Max Daily Queries</label> <input
							type="number" class="form-control" name="dailyMaxQuery" value="${feeds.dailyMaxQuery}" required="required">
					</div>
					
					<div class="form-group">
						<label for="revenue share">Revenue Share</label> <input
							type="number" class="form-control" name="revenueShare" value="${feeds.revenueShare}" required="required">
					</div>
					
					
					<div class="form-group">
						<label for="platform">Platform</label> <input
							type="text" class="form-control" name="platform" value="${feeds.platform}" required="required">
					</div>
					
					<div class="form-group">
					<label for="status">status</label>
					<c:if test="${feeds.status}">
					<input type="checkbox" name="status" id="switch" checked="checked"/><label for="switch" class="toggle">Toggle</label>
					</c:if>
					<c:if test="${feeds.status eq false}">
						<input type="checkbox" name="status" id="switch" /><label for="switch" class="toggle">Toggle</label>
					</c:if>
