...
<title>AdKrive - All Sms Unverified publishers</title>
<!-- site favicon -->
<base
						...
						<li class="sidebar-menu-item sidebar-dropdown"><a
							...
							<div class="sidebar-submenu sidebar-submenu__open ">
								<ul>
									...
									<li class="sidebar-menu-item "><a
										href="/publisher/sms-unverified active" class="nav-link"> <i
											class="menu-icon las la-dot-circle"></i> <span
			...
			<div class="bodywrapper__inner">
				<div class="row align-items-center mb-30 justify-content-between">
					<div class="col-lg-6 col-sm-6">
						<h6 class="page-title" id="change">All Sms Unverified  publishers</h6>
					</div>
														...
														<c:forEach items="${listOfAllSmsUnverifiedPublisher}"
															...
															<tr>
																...
																<c:if test="${element.status eq 1}"><span class="text--small badge font-weight-normal badge--success">Active</span></c:if>
                              											...
                              											<c:if test="${element.status eq 2}"><span class="text--small badge font-weight-normal badge--warning ">Banned</span></c:if>
