...
<head>
  ...
  <title>AdKrive - All Advertises</title>
    <!-- site favicon -->
    <base
                        ...
                        <table class="table table--light style--two">
                            ...
                            <tbody>
                            	...
                            	<c:forEach items="${listAdvertise}" var="element">
                            		...
                            		<tr>
                                    	 <td data-label="Ad Name" class="text--primary">${element.ad_name}</td>
                                    	  <td data-label="Ad title" class="text--primary">${element.ad_title}</td>
                                    	  <td data-label="Type" class="text--primary">${element.ad_type}</td>
                                    	  <td data-label="Advertiser" class="text--primary">${element.advertiser_id}</td>
                                    	  <td data-label="Impression" class="text--primary">${element.impression}</td>
                                    	  <td data-label="Click" class="text--primary">${element.clicked}</td>
                                    	  <td data-label="Status">
                                    
                                    
                                            
                                           <c:if test="${element.status eq 1}"><span class="text--small badge font-weight-normal badge--success">Active</span></c:if>  
                                           <c:if test="${element.status eq 0}"><span class="text--small badge font-weight-normal badge--warning">Deactive</span></c:if> 
                                      
                                      		 <td data-label="Action">
                                        <button type="button" class="icon-btn btn--primary edit"
                                                data-name="${element.ad_name}"
