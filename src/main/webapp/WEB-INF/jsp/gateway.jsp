                            					...
                            					<c:otherwise>
                            							<c:forEach items="${gatewayList}" var="element">
                            									...
                            									<tr>
                                    								<td data-label="Gateway">
                                        								<div class="user">
                                           							 <div class="thumb"><img src="images/800x800.png" alt="image"></div>
                                    					...
                                    					<td data-label="Supported Currency">${fn:length(fn:split(element.supported_currencies, ','))}
                                    						...
                                    						<td data-label="Action">
                                        						...
                                        						<a href="/gateway/automatic/edit/${element.alias}" class="icon-btn editGatewayBtn" data-toggle="tooltip" title="" data-original-title="Edit">
   ...
   <div id="activateModal" class="modal fade" tabindex="-1" role="dialog">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/gateway/automatic/activate" method="POST">
                    <input type="hidden" name="_token" value="5oasvCaNnqLMzcFxwaydaC5MPdU9axxbM2HjogYo">                    <input type="hidden" name="code">
    ...
    <div id="deactivateModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="/gateway/automatic/deactivate" method="POST">
                    <input type="hidden" name="_token" value="5oasvCaNnqLMzcFxwaydaC5MPdU9axxbM2HjogYo">                    <input type="hidden" name="code">
