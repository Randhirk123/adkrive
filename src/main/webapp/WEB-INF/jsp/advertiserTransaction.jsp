...
<title>AdKrive - Advertiser Transaction ${advertse.name}</title>
<!-- site favicon -->
<base
...
<li class="sidebar-menu-item sidebar-dropdown">
 ...
 <span class="navbar-user">
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Advertiser Transactions ${advertise.name} </h6>
    </div>
                            		...
                            		<c:when test="${empty advTxLog}">
                            				...
                            				<c:otherwise>
                            						...
                            						<c:forEach items="${advTxLog}" var="element">
                            								...
                            								<tr>
                                <td data-label="Date"><fmt:formatDate type = "both" value = "${element.date}" pattern="dd-MMM-yyyy"/></td>
                                <td data-label="TRX" class="font-weight-bold">${element.trx}</td>
                                <td data-label="Username"><a href="/publisher/details/${element.publisher_id}">${advertise.username}</a></td>
