            ...
            <div class="card b-radius--10 overflow-hidden box--shadow1">
                <div class="card-body p-0">
                    <div class="p-3 bg--white">
                        ...
                        <div class="" data-toggle="popover-hover" data-img="images/default.png">
                            <img src="images/default.png" alt="profile-image"
                                 class="b-radius--10 w-100">
                        </div>
                        <div class="mt-15">
                            <h4 class="">${advertise.name}</h4>
                            <span class="text--small">Joined At <strong><fmt:formatDate type="both" value="${advertise.created_at}" /></strong></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            ...
                            <c:if test="${advertise.status eq 1}"><span class="text--small badge font-weight-normal badge--success">Active</span></c:if>
                              <c:if test="${advertise.status eq 0}"><span class="text--small badge font-weight-normal badge--warning">Deactive</span></c:if>
                              <c:if test="${advertise.status eq 2}"><span class="text--small badge font-weight-normal badge--warning ">Banned</span></c:if>
            ...
            <div class="row mb-none-30">
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--gradi-1 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">${advertise.balance}</span>
               ...
               <!-- dashboard-w1 end -->
                ...
                <div class="col-xl-4 col-lg-6 col-sm-6 mb-30">
                    <div class="dashboard-w1 bg--gradi-21 b-radius--10 box-shadow has--link">
                        ...
                        <div class="details">
                            <div class="numbers">
                                <span class="amount">${advTxCount}</span>
