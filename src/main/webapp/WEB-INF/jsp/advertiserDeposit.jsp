...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
   <title>AdKrive - Advertiser Deposit : ${advertise.name}</title>
    <base
...
<!-- navbar-wrapper end -->
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">Advertiser Deposit : ${advertise.name}</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
            
         <form action="/deposit/list/search" method="GET" class="form-inline float-sm-right bg--white">
            <div class="input-group has_append  ">
                <input type="text" name="search" class="form-control" placeholder="Deposit code" value="">
                    ...
                    <table class="table table--light style--two">
                        ...
                        <tbody>
                        		<c:choose>
                        				...
                        				<c:when test="${empty advDepositList}">
                        					 <td class="text-muted text-center" colspan="100%">No  deposits.</td>
                        				</c:when>
                        				
                        				<c:otherwise>
                        				
                        					<c:forEach items="${advDepositList}" var="element">
