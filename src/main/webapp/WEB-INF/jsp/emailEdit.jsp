...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
 <title>AdKrive - ${email.name}</title>
<base
...
<body>
    ...
    <div class="col-lg-6 col-sm-6">
        <h6 class="page-title">${email.name}</h6>
    </div>
    <div class="col-lg-6 col-sm-6 text-sm-right mt-sm-0 mt-3 right-part">
            <a href="/email-template/index" class="btn btn-sm btn--primary box--shadow1 text--small"><i class="fa fa-fw fa-backward"></i> Go Back </a>
    </div>
</div>
                    <div class="row">
        <div class="col-lg-12">
                                  ...
                                  <tr>
                            			...
                            			<c:otherwise>
                            				<c:forEach items="${map}" var="entry">
                            				  ...
                            				  <tr> 
                            				  		  <td data-label="Name">{{${entry.key}}}</td>   
                            				  		  <td data-label="Description">${entry.value}</td>                    
                                			</tr>
                                			</c:forEach>
                                			</c:otherwise>
                                			</c:choose>
        ...
        <div class="col-lg-12">
            ...
            <div class="card mt-5">
                <div class="card-header bg--dark">
                    <h5 class="card-title text-white">${email.name}</h5>
                </div>
                <form:form action="/email-template/${id}/update" method="POST" modelAttribute="email">
                    <input type="hidden" name="_token" value="UYQ8fNUujvswib1IQbPkAkcOQMkXqLUMEs3FlSP0">                    <div class="card-body">
                        <div class="form-row">
                        <div class="form-group col-md-8">
                                <label class="font-weight-bold">Subject <span class="text-danger">*</span></label>
                                <input type="text" class="form-control form-control-lg" placeholder="Email subject" name="subj" value="${email.subj}"/>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="font-weight-bold">Status <span class="text-danger">*</span></label>
                                <input type="checkbox" data-height="46px" data-width="100%" data-onstyle="-success" data-offstyle="-danger" data-toggle="toggle" data-on="Send Email" data-off="Don't Send" name="email_status1" 
                                <c:if test="${email.email_status eq 1}">checked="checked"</c:if> />
											<input type="hidden" value="0" name="_email_status1" id="chk_1" />
                            </div>

                           <div class="form-group col-md-12">
                                <label class="font-weight-bold">Message <span class="text-danger">*</span></label>
                                <textarea name="email_body" rows="10" class="form-control nicEdit" placeholder="Your message using shortcodes">${email.email_body}</textarea>
                            </div>
                        </div>
                    </div>
